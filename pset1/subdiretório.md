...
### Esse subdiretório, *pset1*, servirá para ser postado as resoluções das atividades 3.4 e 3.6 sobre a implementação do projeto lógico no livro do ELMASRI no PostgreSQL e no MariaDB.
